...
## Installation for Devs <a name="installDevs">
...
## Installation for Players <a name="installPlayers">
...
### 1. Digital Inputs<a name="digitalInputs">
...
### 2. Stick Mouse Inputs<a name="stickInputs">
...
### 3. Gyro Mouse Inputs<a name="gyroInputs">
...
### 4. Real World Calibration<a name="realWorldCalibration">
...
### 5. Miscellaneous Commands<a name="misc">
...
## Known and Perceived Issues <a name="issues">
### Polling rate
...
## Helpful Resources <a name="helpfulResources">
